...
const GET_USER_PATH = `/${API_VERSION}/tenancy/users/`;
const RESOURCE_URL = `${API_BASE_URL}${GET_USER_PATH}`;
const REQUEST_METHOD = "GET";

async function getUser({ username }) {
    // Request path
    const path = `${GET_USER_PATH}${username}`;
